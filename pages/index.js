  ...
  return (
    <div className="xl:h-screen py-10 lg:px-12 grid place-content-center">
      <div className="bg-red-400 max-w-5xl text-center py-24 px-12 md:px-48 md:py-48 rounded-lg">
        ...
        <a
          href="/api/signup"
          className="mt-8 w-full inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-red-500 bg-white hover:bg-indigo-50 sm:w-auto"
        >
          Join Today
        </a>
      </div>
